# Set AWS profile to use levi2
export AWS_PROFILE=levi2
...
vpc_id=$(aws ec2 describe-vpcs --filters Name="tag:Name",Values="vividly" \
...
pub_rt_id=$(aws ec2 describe-route-tables --filters Name="vividly-public",Values=$vpc_id \
